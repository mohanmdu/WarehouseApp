...
public class UserController {
	...
	List<User> buildUsers() {
		...
		User user6 = buildUser(6L, "Pazhani", "Deva", "pazani@email.com");
		User user7 = buildUser(7L, "Sekhar", "Pathapalem", "sekhar@email.com");
		User user8 = buildUser(8L, "Aruna", "Dorai", "aruna@email.com");
